...
* [Click to expand/collapse nodes](https://kmanxhuka.github.io/3d-force-graph/example/expandable-nodes/) ([source](https://github.com/kmanxhuka/3d-force-graph/blob/master/example/expandable-nodes/index.html))
